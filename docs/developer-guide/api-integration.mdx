...
**Example:**
```bash
curl "https://api.haveibeendrained.com/api/v1/check?address=ABC123...&limit=50"
```
...
**Example:**
```bash
curl "https://api.haveibeendrained.com/api/v1/drainer/ABC123..."
```
...
**Example:**
```bash
curl "https://api.haveibeendrained.com/api/v1/analyze/ABC123...?limit=100"
```
...
class HaveIBeenDrained {
  constructor(apiKey = null) {
    this.baseUrl = 'https://api.haveibeendrained.com';
    this.apiKey = apiKey;
  }
...
class HaveIBeenDrained:
    def __init__(self, api_key: Optional[str] = None):
        self.base_url = 'https://api.haveibeendrained.com'
...
func (c *HaveIBeenDrained) Check(address string) (map[string]interface{}, error) {
    baseURL := "https://api.haveibeendrained.com"
    if c.BaseURL != "" {
        baseURL = c.BaseURL
    }
