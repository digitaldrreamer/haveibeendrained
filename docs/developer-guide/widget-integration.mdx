...
<body>
  ...
  <!-- Widget script -->
  <script src="https://widget.haveibeendrained.org/v1/widget.js"></script>
  <script>
    HIBDWidget.init({
...
function WalletChecker() {
  ...
  useEffect(() => {
    ...
    script.src = 'https://widget.haveibeendrained.org/v1/widget.js';
    script.onload = () => {
...
function enqueue_hibd_widget() {
    wp_enqueue_script(
        'hibd-widget',
        'https://widget.haveibeendrained.org/v1/widget.js',
        array(),
        '1.0.0',
        true
    );
